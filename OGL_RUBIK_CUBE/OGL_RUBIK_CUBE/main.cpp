...
int main()
{
    ...
    unsigned char* data = stbi_load("C:\\Users\\Fernanda\\Desktop\\OGL_RUBIK_CUBE\\OGL_RUBIK_CUBE\\cuboRubik.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("C:\\Users\\Fernanda\\Desktop\\OGL_RUBIK_CUBE\\OGL_RUBIK_CUBE\\awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
